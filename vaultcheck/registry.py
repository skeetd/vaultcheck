...
REGISTRY: list[Check] = [
    ...
    Check("https-redirect", "HTTPS redirect & HSTS", "Web", "url", "free", False, check_https_redirect,
          "Checks HTTP→HTTPS redirect and HSTS strength/preload eligibility."),
    Check("cookies", "Cookie flags", "Web", "url", "free", False, check_cookies,
          "Inspects Set-Cookie for Secure, HttpOnly and SameSite."),
    Check("mixed-content", "Mixed content", "Web", "url", "free", False, check_mixed_content,
          "Finds insecure HTTP sub-resources loaded by an HTTPS page."),
    ...
    Check("open-redirect", "Open redirect", "Web", "url", "free", True, check_open_redirect,
          "Probes common redirect parameters for unvalidated external redirects. Authorized targets only."),
